        ...
        <div class="row py-5">
              ...
              <div id="collapseCat" class="collapse">
                <ul class="list-unstyled">
                  ...
                  foreach ($categories as $row) {
                    ...
                    ?>
                    <li class="mb-1"><a href="<?php echo '?category='; echo $lowercasecol['Category']?>" id="<?php echo $lowercasecol['Category']?>" style="font-size: .85rem;"><?php echo $row['Category'] ?></a></li>
                  <?php }
                  ?>
                </ul>
              </div>
              ...
              <div id="collapseCol" class="collapse">
                <ul class="list-unstyled h-100">
                  ...
                  foreach($collections as $row) {
                    ...
                    $lowercasecol = array_map('strtolower', $removeamp);
                    ?>
                    <li class="mb-1"><a href="<?php echo '?collection='; echo $lowercasecol['Collection']?>" id="" style="font-size: .85rem;"><?php echo $row['Collection'] ?></a></li>
                  <?php } ?>
                </ul>
              </div>
            </div>
            <div class="pb-5">
              ...
              <div id="collapseSubCol" class="collapse">
                <ul class="list-unstyled">
                  ...
                  $result = $pdo->prepare($sql);
                  $result->execute();
                  $subCollections = $result->fetchAll();
                  $removethisstuff = array(" ", "&");
                  $addthisstuff = array("", "+");
                  foreach($subCollections as $row) {
                    $removeamp = str_replace($removethisstuff, $addthisstuff, $row);
                    $lowercasecol = array_map('strtolower', $removeamp);
                    ?>
                    <li class="mb-1"><a href="<?php echo '?subcollection='; echo $lowercasecol['Sub_Collection']?>" id="" style="font-size: .85rem;"><?php echo $row['Sub_Collection'] ?></a></li>
                  <?php } ?>
                </ul>
              </div>
            </div>
          ...
          <div class="col-lg-10">
            <div class="row no-gutters" id="result">
              ...
              <?php
              $sql="SELECT Prefix, Name, SKU FROM regency_products GROUP BY Prefix ORDER BY Prefix, Name ASC LIMIT $start_from, ".$rpp;
              $result = $pdo->prepare($sql);
              $result->execute();
